...
public class OriginalWorkTitle implements Record {
    ...
    public static OriginalWorkTitle parse(String line) throws CWRParsingException {
    ...
    public String toRecord() {
        return String.format(
                ...
                Utils.recordPrefix("VER", this.transaction_sequence, this.record_sequence),
